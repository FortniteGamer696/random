...
queueonteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/FortniteGamer696/random/main/test.lua'))()")
local Flux = loadstring(game:HttpGet"https://raw.githubusercontent.com/dawid-scripts/UI-Libs/main/fluxlib.txt")()
local win = Flux:Window("PLS DONATE", "by fortnitegamer812", Color3.fromRGB(0, 128, 0), Enum.KeyCode.RightShift)
